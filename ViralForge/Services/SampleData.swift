...
enum SampleData {
    ...
    private static let chineseTemplates: [CreativeTemplate] = [
        ...
        CreativeTemplate(name: "小红书成分党解析帖", category: .productSeeding, platform: .xiaohongshu, style: .editorial, promptHint: "适合美妆、食品、健康小家电，把核心成分/配置拆成用户能理解的购买理由"),
        CreativeTemplate(name: "抖音问题解决型脚本", category: .productSeeding, platform: .douyin, style: .boldLaunch, promptHint: "用一个高频痛点开场，展示产品如何解决问题并给出强行动号召"),
        ...
        CreativeTemplate(name: "小红书周末路线攻略", category: .storeTraffic, platform: .xiaohongshu, style: .softLifestyle, promptHint: "把门店或本地服务包装成周末半日路线，包含时间、预算、拍照点和收藏理由"),
        CreativeTemplate(name: "微信会员日到店提醒", category: .storeTraffic, platform: .weChat, style: .boldLaunch, promptHint: "生成会员日私域提醒、到店福利、限时权益和转发话术"),
        ...
        CreativeTemplate(name: "小红书专业清单封面", category: .personalBrand, platform: .xiaohongshu, style: .editorial, promptHint: "把专业经验整理成清单式封面和正文结构，突出可保存、可转发"),
        CreativeTemplate(name: "微信顾问式成交故事", category: .personalBrand, platform: .weChat, style: .editorial, promptHint: "用顾问视角讲一个用户从犹豫到下单的过程，强调判断依据和信任建立"),
        ...
        CreativeTemplate(name: "抖音直播爆品清单", category: .liveLaunch, platform: .douyin, style: .boldLaunch, promptHint: "把直播间主推款做成清单预热视频，突出价格、福利、适合人群和进场时间", lockedToPro: true),
        CreativeTemplate(name: "微信直播复盘转化帖", category: .liveLaunch, platform: .weChat, style: .editorial, promptHint: "直播结束后面向未下单用户做复盘、补充权益和二次转化", lockedToPro: true),
        ...
        CreativeTemplate(name: "小红书换季必买清单", category: .seasonalPromo, platform: .xiaohongshu, style: .cleanProduct, promptHint: "围绕换季场景生成必买清单、封面方向和预算分层"),
        CreativeTemplate(name: "抖音节日限时口播", category: .seasonalPromo, platform: .douyin, style: .boldLaunch, promptHint: "生成节日限时促销口播脚本和强钩子首帧"),
        ...
        CreativeTemplate(name: "微信新品内测招募", category: .newLaunch, platform: .weChat, style: .editorial, promptHint: "生成私域新品内测招募文案，突出名额、反馈价值和优先体验权益"),
        CreativeTemplate(name: "小红书新品 FAQ 图文", category: .newLaunch, platform: .xiaohongshu, style: .cleanProduct, promptHint: "把新品常见疑问整理成 FAQ 图文结构，降低购买顾虑")
    ]
    ...
    private static let englishTemplates: [CreativeTemplate] = [
        ...
        CreativeTemplate(name: "Instagram Ingredient Breakdown", category: .productSeeding, platform: .instagram, style: .editorial, promptHint: "Turn ingredients, specs, or features into a plain-language carousel that explains why the product matters"),
        CreativeTemplate(name: "TikTok Problem Solution Script", category: .productSeeding, platform: .tikTok, style: .boldLaunch, promptHint: "Open with a common pain point, show the product solving it, and end with a clear CTA"),
        ...
        CreativeTemplate(name: "Instagram Weekend Route Guide", category: .storeTraffic, platform: .instagram, style: .softLifestyle, promptHint: "Turn a local place or service into a weekend route with timing, budget, photo moments, and save-worthy details"),
        CreativeTemplate(name: "YouTube Shorts Local Deal Alert", category: .storeTraffic, platform: .youtubeShorts, style: .boldLaunch, promptHint: "Create a quick local deal script with what to book, why now, and how to act"),
        ...
        CreativeTemplate(name: "Instagram Expert Checklist Cover", category: .personalBrand, platform: .instagram, style: .editorial, promptHint: "Package expert advice into a saveable checklist cover and carousel flow"),
        CreativeTemplate(name: "TikTok Consultant Story", category: .personalBrand, platform: .tikTok, style: .softLifestyle, promptHint: "Tell a trust-building client or buyer journey from hesitation to decision"),
        ...
        CreativeTemplate(name: "TikTok Live Product Lineup", category: .liveLaunch, platform: .tikTok, style: .boldLaunch, promptHint: "Create a live-shopping product lineup teaser with hero offers, timing, and reminder CTA", lockedToPro: true),
        CreativeTemplate(name: "Instagram Post-Live Conversion", category: .liveLaunch, platform: .instagram, style: .editorial, promptHint: "Create a post-live recap that turns missed viewers into buyers with a second-chance CTA", lockedToPro: true),
        ...
        CreativeTemplate(name: "Instagram Seasonal Essentials List", category: .seasonalPromo, platform: .instagram, style: .cleanProduct, promptHint: "Create a seasonal essentials list with budget tiers, use cases, and a poster direction"),
        CreativeTemplate(name: "TikTok Holiday Flash Sale Script", category: .seasonalPromo, platform: .tikTok, style: .boldLaunch, promptHint: "Create a holiday flash-sale short script with urgency, offer clarity, and first-frame hook"),
        ...
        CreativeTemplate(name: "Instagram Beta Tester Call", category: .newLaunch, platform: .instagram, style: .editorial, promptHint: "Create a beta tester recruitment post for a new product with limited spots and early-access benefits"),
        CreativeTemplate(name: "YouTube Shorts Launch FAQ", category: .newLaunch, platform: .youtubeShorts, style: .cleanProduct, promptHint: "Turn launch objections into a fast FAQ script and cover direction")
    ]
