...
This file is the copy source for ViralForge App Store Connect metadata. The app is a single iOS bundle with locale-driven Chinese and English modes.
...
- E-commerce sellers and local businesses
- Brand and content marketers
- Freelancers and personal brands
- Teams that need consistent content output
...
Use this as a conservative draft for App Store Connect App Privacy. Final answers must match the exact Release backend behavior.
...
If the Release build uses the ViralForge backend, disclose:

- User Content: product briefs, prompts, generated copy, poster drafts, brand profile fields, and saved projects.
...
- No, unless the product later intentionally collects sensitive categories. User prompts can contain arbitrary user-entered text, so the privacy policy asks users not to submit sensitive or regulated information.
