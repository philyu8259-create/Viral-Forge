...
const defaultTemplates = [
  ...
  { templateId: "xhs-ingredient-breakdown", name: "小红书成分党解析帖", category: "Product Seeding", platform: "xiaohongshu", style: "Editorial", promptHint: "适合美妆、食品、健康小家电，把核心成分/配置拆成用户能理解的购买理由", lockedToPro: false },
  { templateId: "douyin-problem-solution-script", name: "抖音问题解决型脚本", category: "Product Seeding", platform: "douyin", style: "Bold", promptHint: "用一个高频痛点开场，展示产品如何解决问题并给出强行动号召", lockedToPro: false },
  ...
  { templateId: "xhs-weekend-route-guide", name: "小红书周末路线攻略", category: "Store Traffic", platform: "xiaohongshu", style: "Soft", promptHint: "把门店或本地服务包装成周末半日路线，包含时间、预算、拍照点和收藏理由", lockedToPro: false },
  { templateId: "wechat-member-day-reminder", name: "微信会员日到店提醒", category: "Store Traffic", platform: "wechat", style: "Bold", promptHint: "生成会员日私域提醒、到店福利、限时权益和转发话术", lockedToPro: false },
  ...
  { templateId: "xhs-expert-checklist-cover", name: "小红书专业清单封面", category: "Personal Brand", platform: "xiaohongshu", style: "Editorial", promptHint: "把专业经验整理成清单式封面和正文结构，突出可保存、可转发", lockedToPro: false },
  { templateId: "wechat-consultative-sales-story", name: "微信顾问式成交故事", category: "Personal Brand", platform: "wechat", style: "Editorial", promptHint: "用顾问视角讲一个用户从犹豫到下单的过程，强调判断依据和信任建立", lockedToPro: false },
  ...
  { templateId: "douyin-live-product-lineup", name: "抖音直播爆品清单", category: "Live Launch", platform: "douyin", style: "Bold", promptHint: "把直播间主推款做成清单预热视频，突出价格、福利、适合人群和进场时间", lockedToPro: true },
  { templateId: "wechat-post-live-conversion", name: "微信直播复盘转化帖", category: "Live Launch", platform: "wechat", style: "Editorial", promptHint: "直播结束后面向未下单用户做复盘、补充权益和二次转化", lockedToPro: true },
  ...
  { templateId: "xhs-seasonal-essentials-list", name: "小红书换季必买清单", category: "Seasonal Promo", platform: "xiaohongshu", style: "Clean", promptHint: "围绕换季场景生成必买清单、封面方向和预算分层", lockedToPro: false },
  { templateId: "douyin-holiday-flash-sale", name: "抖音节日限时口播", category: "Seasonal Promo", platform: "douyin", style: "Bold", promptHint: "生成节日限时促销口播脚本和强钩子首帧", lockedToPro: false },
  ...
  { templateId: "wechat-beta-tester-call", name: "微信新品内测招募", category: "New Launch", platform: "wechat", style: "Editorial", promptHint: "生成私域新品内测招募文案，突出名额、反馈价值和优先体验权益", lockedToPro: false },
  { templateId: "xhs-launch-faq-post", name: "小红书新品 FAQ 图文", category: "New Launch", platform: "xiaohongshu", style: "Clean", promptHint: "把新品常见疑问整理成 FAQ 图文结构，降低购买顾虑", lockedToPro: false },
  ...
  { templateId: "instagram-ingredient-breakdown", name: "Instagram Ingredient Breakdown", category: "Product Seeding", platform: "instagram", style: "Editorial", promptHint: "Turn ingredients, specs, or features into a plain-language carousel that explains why the product matters", lockedToPro: false },
  { templateId: "tiktok-problem-solution-script", name: "TikTok Problem Solution Script", category: "Product Seeding", platform: "tiktok", style: "Bold", promptHint: "Open with a common pain point, show the product solving it, and end with a clear CTA", lockedToPro: false },
  ...
  { templateId: "instagram-weekend-route-guide", name: "Instagram Weekend Route Guide", category: "Store Traffic", platform: "instagram", style: "Soft", promptHint: "Turn a local place or service into a weekend route with timing, budget, photo moments, and save-worthy details", lockedToPro: false },
  { templateId: "shorts-local-deal-alert", name: "YouTube Shorts Local Deal Alert", category: "Store Traffic", platform: "youtube_shorts", style: "Bold", promptHint: "Create a quick local deal script with what to book, why now, and how to act", lockedToPro: false },
  ...
  { templateId: "instagram-expert-checklist-cover", name: "Instagram Expert Checklist Cover", category: "Personal Brand", platform: "instagram", style: "Editorial", promptHint: "Package expert advice into a saveable checklist cover and carousel flow", lockedToPro: false },
  { templateId: "tiktok-consultant-story", name: "TikTok Consultant Story", category: "Personal Brand", platform: "tiktok", style: "Soft", promptHint: "Tell a trust-building client or buyer journey from hesitation to decision", lockedToPro: false },
  ...
  { templateId: "tiktok-live-product-lineup", name: "TikTok Live Product Lineup", category: "Live Launch", platform: "tiktok", style: "Bold", promptHint: "Create a live-shopping product lineup teaser with hero offers, timing, and reminder CTA", lockedToPro: true },
  { templateId: "instagram-post-live-conversion", name: "Instagram Post-Live Conversion", category: "Live Launch", platform: "instagram", style: "Editorial", promptHint: "Create a post-live recap that turns missed viewers into buyers with a second-chance CTA", lockedToPro: true },
  ...
  { templateId: "instagram-seasonal-essentials-list", name: "Instagram Seasonal Essentials List", category: "Seasonal Promo", platform: "instagram", style: "Clean", promptHint: "Create a seasonal essentials list with budget tiers, use cases, and a poster direction", lockedToPro: false },
  { templateId: "tiktok-holiday-flash-sale", name: "TikTok Holiday Flash Sale Script", category: "Seasonal Promo", platform: "tiktok", style: "Bold", promptHint: "Create a holiday flash-sale short script with urgency, offer clarity, and first-frame hook", lockedToPro: false },
  ...
  { templateId: "instagram-beta-tester-call", name: "Instagram Beta Tester Call", category: "New Launch", platform: "instagram", style: "Editorial", promptHint: "Create a beta tester recruitment post for a new product with limited spots and early-access benefits", lockedToPro: false },
  { templateId: "shorts-launch-faq", name: "YouTube Shorts Launch FAQ", category: "New Launch", platform: "youtube_shorts", style: "Clean", promptHint: "Turn launch objections into a fast FAQ script and cover direction", lockedToPro: false }
];
