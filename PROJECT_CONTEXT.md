...
- Latest end-to-end checks passed: `xcodebuild ... test` on iPhone 17 simulator for English locale generation, Chinese mock generation, result copy-pack export, result edit/save, and poster export/assets flows; backend `npm run check` also passed.
